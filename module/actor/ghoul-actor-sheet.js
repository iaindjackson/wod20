  ...
  _prepareItems(sheetData) {
    ...
    for (const i of sheetData.items) {
      if (i.type === "power") {
        ...
        if (i.data.powertype === "discipline" && i.data.power !== undefined) {
          console.log("that's the discipline", i.data.power);
          if (i.data.power in disciplines) {
            disciplines[i.data.power].push(i);
            if (!this.actor.data.data.disciplines[i.data.power].visible) {
              this.actor.update({
                [`data.disciplines.${i.data.power}.visible`]: true,
              });
            }
          }
        }
